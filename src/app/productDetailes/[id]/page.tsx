  ...
  return (
    <>
      <section className="flex flex-col text-center p-12 gap-4 w-full items-center lg:p-24">
        <NFT_info_Block card={card} handler={()=>{useOpenPopup(!openPopup)}} />
        ...
        {
          openPopup && <div className="absolute w-full h-full top-0 left-0 z-50 flex justify-center items-center">
            <div className="absolute w-full h-full bg-white bg-opacity-20 shadow-[0_4px_30px_rgba(0,0,0,0.1)] backdrop-blur-md" onClick={()=>useOpenPopup(false)}></div>
            <div className="z-[51]">
          <Bid_history_popup />
